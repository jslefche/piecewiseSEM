...
![example_sem](https://github.com/jslefche/jslefche.github.io/blob/master/img/example_sem.jpg?raw=true) 
...
![sem_missing](https://github.com/jslefche/jslefche.github.io/blob/master/img/sem_missing_paths.jpg?raw=true)
...
![glmSEM](https://github.com/jslefche/jslefche.github.io/blob/master/img/GLM_sem.jpg?raw=true)
...
```
In option 2, the SEM can be updated to remove that test.
```{r}
...
### 2.3 Standardized coefficients for GLMs
...
Shipley (2013) notes that the Fisher's C statistic can be used to 
...
![ShipleySEM](https://github.com/jslefche/jslefche.github.io/blob/master/img/shipley_sem.jpg?raw=true)
