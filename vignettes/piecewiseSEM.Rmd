...
Now, we repeat the exercise using the new functions.
```{r, messages = FALSE}
shipley.psem <- psem(
...
`sem.lavaan` has not yet been ported to version 2.0, and it may not, as there was some confusion how multi-level models were translated to the variance-covariance framework (they weren't, only the formulae were ported).
