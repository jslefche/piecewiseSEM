...
Users are able to construct a list of structured equations corresponding to a single caustal network using the most common linear modeling functions, including: `lm`, `glm`, '`gls`, `pgls`, `lme`, `lmer`, `glmer`, and `glmmPQL`. 
...
shipley2009.new.pred = predict.sem(shipley2009.modlist, shipley2009.new)
...
shipley2009.new.pred = predict.sem(shipley2009.modlist, shipley2009.new, sefit = TRUE)
