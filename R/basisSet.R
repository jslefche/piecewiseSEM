...
#' @keywords internal
#' 
reverseNonLin <- function(b, modelList, amat) { ##### MODIFIED FUNCTION: see https://github.com/jslefche/piecewiseSEM/issues/252
  
  if(length(b) > 0 || !all(colSums(amat) != 0)) { #### MODIFIED LINE
